...
\thesistitle{Deep Collaborative Filtering for Attribute Tagging} %\ttitle
...
Collaborative filtering (CF) has proven to be an effective approach for predicting the unknown preferences of users, using the known preferences of other users in a group. Latent factor models have have been used to achieve state-of-the-art accuracy in many CF settings. These models use latent features in both users and items that are learned through training to predict user preferences.
\end{abstract}
