...
However, two alternative metrics have been formulated by \parencite{eval_coverage} which aim to better reflect the quality perceived by users of the system, namely coverage and serendipity.
...
\end{equation}
\hspace{2em} which is the total number of items recommended by the system divided by the total number of items contained in the training data.
